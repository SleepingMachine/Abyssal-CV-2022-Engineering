...
int IdentifyOre::hmax_0_ = 50;
int IdentifyOre::smin_0_ = 230;
int IdentifyOre::smax_0_ = 255;
int IdentifyOre::vmin_0_ = 70;
...
int IdentifyOre::close_  = 18;
int IdentifyOre::erode_  = 3;
int IdentifyOre::dilate_ = 6;
...
void IdentifyOre::OreIdentifyStream(cv::Mat *import_src_color, int *sentData) {
...
void IdentifyOre::ImagePreprocess(const cv::Mat &src) {
    ...
    cv::inRange(src_color_HSV_, cv::Scalar(hmin_0_, smin_0_, vmin_0_),
                                    cv::Scalar(hmax_0_, smax_0_, vmax_0_),color_mask_);
