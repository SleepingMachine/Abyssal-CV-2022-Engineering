...
#ifndef ABYSSAL_CV_2022_SERIAL_PORT_TUP_HPP
#define ABYSSAL_CV_2022_SERIAL_PORT_TUP_HPP
/**
 *@class  SerialPortTUP
 *@brief  set SerialPortTUP,recieve and send
 *@param  int fd
 */
#include <sys/types.h>
#include <unistd.h>
...
#include <iostream>
#include <mutex>
//#include "../src/switch/switch-mode.hpp"
#include "serial-CRC-TUP/serial-CRC-TUP.hpp"
...
public:
    ...
    static void SerialSynchronizeTUP(int64_t * sentData);
//  int set_disp_mode(int);
//  void TransformTarPos(const VisionData &data);
};

#endif //ABYSSAL_CV_2022_SERIAL_PORT_TUP_HPP
